...
密钥生成：
CKM_EC_KEY_PAIR_GEN        EC密钥对生成（通用）
CKM_ECDSA_KEY_PAIR_GEN     ECDSA密钥对生成
CKM_ECDH_KEY_PAIR_GEN      ECDH密钥对生成
...
PKCS#11支持：
CKM_X25519_KEY_PAIR_GEN  X25519密钥生成
CKM_X25519               X25519密钥协商
CKM_ED25519_KEY_PAIR_GEN Ed25519密钥生成
CKM_EDDSA                EdDSA签名
```
